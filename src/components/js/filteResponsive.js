...
const filteResponsive = ({ closeFilterMobile }) => {
  ...
  const categories = [
    ...
    },
    {
      ...
      items: [
        {
          id: "Gilbert-Emmanuel",
          name: "Gilbert-Emmanuel",
          label: "Gilbert Emmanuel",
          count: 241,
        },
        {
          id: "Boutavant-Marc",
          name: "Boutavant-Marc",
          label: "Boutavant Marc",
          count: 117,
        },
        { id: "Indochine", name: "Indochine", label: "Indochine", count: 36 },
        {
          id: "Beethoven-Ludwig-Van",
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: "Musique-Populaire",
          name: "Musique-Populaire",
          label: "Musique Populaire",
          count: 117,
        },
        {
          id: "20e-siècle",
    ...
    },
    {
      ...
      items: [
        {
          id: "Sous-titrage Sourds-et-malentendants",
          name: "Sous-titrage Sourds-et-malentendants",
          label: "Sous-titrage Sourds et malentendants",
        },
      ],
    },
  ];
  ...
  return (
    <div className="container_filteResponsive">
      <button
...
export default filteResponsive;
