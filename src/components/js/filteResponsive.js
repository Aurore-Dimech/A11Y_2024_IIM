...
import SearchedBooksCard from "./SearchedBooksCard";
...
const filteResponsive = ({closeFilterMobile})=>  {
    ...
    return (
        <div className="container_filteResponsive">
           <button className="ClosingCross" onClick={closeFilterMobile} >
           <svg role="img" aria-label="flèche" xmlns="http://www.w3.org/2000/svg" width="37" height="37" viewBox="0 0 37 37" fill="none">
